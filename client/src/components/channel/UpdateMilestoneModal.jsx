...
import { updateMilestoneApi } from "../../api/milestone/milestoneApi";

const UpdateMilestoneModal = ({ channel, isUpdated, update, id }) => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      const data = await updateMilestoneApi(channel?._id, channelData);
      console.log(data);
