    ...
    <div className="p-1 pt-0">
      ...
      <form className="mt-4">
        <div className="bg-gray-100 p-3 rounded-lg">
          ...
          <button
            type="submit"
            className="mt-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-200 focus:ring-opacity-50"
          >
            Submit
          </button>
        </div>
